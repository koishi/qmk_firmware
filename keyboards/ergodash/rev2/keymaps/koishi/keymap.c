...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MS_WH_DOWN,                  KC_LBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
    KC_LCTRL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_MS_WH_UP ,                   KC_RBRC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRV, \
    RAISE,     LOWER,  KC_LALT,           KC_LGUI, KC_LANG2,KC_SPC ,_______,        _______,KC_ENT , KC_LANG1,         KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT  \
  ),
   ...
   */
  [_RAISE] = LAYOUT(
    RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                          KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BSPC,  \
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE, \
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_COLN, KC_DQT , \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_JPN ,                        KC_ENT , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    RAISE,   LOWER,   KC_LALT,          KC_LGUI, KC_LANG2,KC_SPC ,_______,        _______,KC_ENT , KC_LANG1,         KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT  \
