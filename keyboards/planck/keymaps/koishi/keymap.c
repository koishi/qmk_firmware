...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SLSH, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SCLN,
    KC_LCTL, KC_LALT, KC_LGUI, KC_LOWES,KC_SPC,  KC_SPC,  KC_ENT,  KC_ENT,  KC_RISKN,KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, KC_BSLS, _______,
